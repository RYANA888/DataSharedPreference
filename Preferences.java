...
public class Preferences
{
	...
	public boolean readBoolean(String name)
	{
		...
		try
		{
			ret = shared_pref.getBoolean(name, false);
	...
	public float readFloat(String name)
	{
		...
		try
		{
			ret = shared_pref.getFloat(name, 0);
		}catch(Exception ignored){}
	...
	public long readLong(String name)
	{
		...
		try
		{
			ret = shared_pref.getLong(name, 0);
		}catch(Exception ignored){}
	...
	public String readString(String name)
	{
		...
		try
		{
			ret = shared_pref.getString(name, "");
		}catch(Exception ignored){}
	 ...
	 * @param name Data Name
	 */
	public Set<String> readSet(String name)
	{
		Set<String> ret = new HashSet<>();
		
		try
		{
			ret = shared_pref.getStringSet(name, new HashSet<String>());
		}catch(Exception ignored){}
